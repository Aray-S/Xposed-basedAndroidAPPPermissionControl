...
public class XhookSettingsProvider extends ContentProvider {
    public final static String AUTHORITY = "com.app.example.provider";
    public static final Uri HOOKSETTING_URI = Uri.parse("content://" + AUTHORITY + "/HOOKSETTING");
    public static final Uri HOOKUSED_URI = Uri.parse("content://" + AUTHORITY + "/HOOKUSED");
    public final static int HOOKSETTINGS = 0;
    public final static int HOOKUSED = 1;
    private static final String[] COLUMN_NAME = {"packagename", "privacyItem"};
        ...
        switch (uriMatcher.match(uri)) {
            case HOOKSETTINGS: {
                ...
                for (Hook hook : hooks) {
                    ...
                    cursor.addRow(new Object[]{hook.getPackageName(), hook.getPrivacyItem()});
                }
                break;
            }
            default:
